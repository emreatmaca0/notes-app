...
session_start();
//---------- Kullanıcı giriş yapmışsa not sayfasına yönlendirir.---------------------
...
<div class="fs-me">
	...
	<div class="me-content">
		...
		<div class="logo" style="margin-bottom: 40px;">
			...
			<img src="images/notew_main.png" alt="Logo" />

		</div>

		<div class="bio">
			
			<p>Notew ile notlarınızı <a href="#">düzenleyin,</a> hızlı bir şekilde <a href="#">erişin</a> ve kolaylıkla <a href="#">paylaşın!</a></p>

		</div>
        
        
        <div>
			<a href="login"><button type="button" class="fill">Giriş Yap</button></a>
			<a href="register"><button type="button" class="slide"><div>Kayıt Ol</div><i class="icon-arrow-right"></i></button></a>
        </div>
		...
		<div class="credit">
			...
			<p class="copyright">&copy;2022 <a href="#">Notew</a> by <a href="https://github.com/emreatmaca0">Emre Atmaca</a></p>
